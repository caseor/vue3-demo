      ...
      <a-row>
        <a-col :span="24">
          <a-card
              ...
              :bordered="false"
          >
            <a-button v-permission="['demo:view:create']" status="success" @click="userInfo">测试按钮</a-button>
...
<script lang="ts">
export default {
  name: 'Homepage' // If you want the include property of keep-alive to take effect, you must name the component
};
</script>
